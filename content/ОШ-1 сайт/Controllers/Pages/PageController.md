...
3. ???
4. Сохраняет подготовленные данные о странице в кэш
...
Аналогичен [[#Получение страницы Карта сайта]], но выполняется поиск по ключу `pages-for-sitemap`
